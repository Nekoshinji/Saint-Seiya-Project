...
function ClothListingSanctuaire() {
  ...
  useEffect(() => {
    // Récupération des cloths de le domain du sanctuaire
    fetch(`${import.meta.env.VITE_API_URL}/cloths/domain/1`)
  ...
  return (
    <>
      ...
      >
            ...
            return (
              ...
              >
                <img
                  ...
                  alt={cloth.img}
                />
                <h2 className="info-cloth">{cloth.armor}</h2>
        ...
        <Link className="new-cloth" to="/clothNewSanctuaire">
          <img
...
export default ClothListingSanctuaire;
