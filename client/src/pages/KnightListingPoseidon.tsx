...
function KnightListingPoseidon() {
  ...
  useEffect(() => {
    // // Récupération des knights dans le domain des océans
    fetch(`${import.meta.env.VITE_API_URL}/knights/domain/3`)
  ...
  return (
    <>
      ...
      >
        ...
        <Link className="new-knight" to="/knigtNewPoseidon">
          <img
...
export default KnightListingPoseidon;
