...
function KnightListingSanctuaire() {
  ...
  useEffect(() => {
    // Récupération des knights dans le domain du sanctuaire
    fetch(`${import.meta.env.VITE_API_URL}/knights/domain/1`)
  ...
  return (
    <>
      ...
      >
        ...
        <Link className="new-knight" to="/knigtNewSanctuaire">
          <img
...
export default KnightListingSanctuaire;
