...
function ClothListingAsgard() {
  ...
  useEffect(() => {
    // Récupération des cloths de le domain d'asgard
    fetch(`${import.meta.env.VITE_API_URL}/cloths/domain/2`)
  ...
  return (
    <>
      ...
      >
        ...
        <Link className="new-link" to="/clothNewAsgard">
          <img
...
export default ClothListingAsgard;
