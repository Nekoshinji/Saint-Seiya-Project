      ...
      >
        <div className="form">
          ...
          <input
            ...
            required
          />
          <label htmlFor="knight-Constellation">Constellation :</label>
          <input
            id="knight-constellation"
            type="text"
            name="constellation"
...
export default KnightFormSanctuaire;
